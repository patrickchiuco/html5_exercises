...
function set_current_audio_name(){
  ...
  audio_header.innerHTML = current_audio_name;
}

function nextaudio(){
  current_audio++;
  audioelement.src = audio_files[current_audio % audio_files.length].file_path;
  set_current_audio_name();
  audioelement.load();
}
